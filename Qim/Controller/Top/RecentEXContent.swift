...
class RecentEXContent: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.loadImage(imageStr: recEx.productImage)
    ...
    func viewTopEx() {
        productName.text = recEx.productName
        opinion.text = recEx.opinion
