...
class Settings: UIViewController {
    ...
    @IBAction func userLogOut(_ sender: Any) {
        ...
        let alert = UIAlertController(title: nil, message: "هل أنت متأكد أنك تريد تسجبل الخروج؟", preferredStyle: .alert)
    ...
    @IBAction func userChangePass(_ sender: Any) {
        ...
        let alert = UIAlertController(title: "إعادة تعيين كلمة المرور", message: "", preferredStyle: .alert)
        alert.addTextField { alerttext in
            alerttext.placeholder = "ادخل كلمة مرور جديدة"
    ...
    @IBAction func userDeleteAccount(_ sender: Any) {
        ...
        let alert = UIAlertController(title: nil, message: "هل أنت متأكد أنك تريد حذف حسابك ؟", preferredStyle: .alert)
        
        let action = UIAlertAction(title: "حذف", style: .default) {_ in
