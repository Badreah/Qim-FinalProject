...
extension Home6: UITableViewDelegate, UITableViewDataSource {
...
extension Home6: UICollectionViewDelegate, UICollectionViewDataSource {
    
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return subcategorys6.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.subCategoryName.text = subcategorys6[indexPath.row].name
