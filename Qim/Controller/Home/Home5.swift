...
extension Home5: UITableViewDelegate, UITableViewDataSource {
...
extension Home5: UICollectionViewDelegate, UICollectionViewDataSource {
    
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return subcategorys5.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.subCategoryName.text = subcategorys5[indexPath.row].name
